...
TEST_CASES = [{'description':'Check that eth0 and brbridged '
               'have the same MAC address',
               'arguments' :  [('dut', '$(DUT)')], 'bvt':True,
               'command_line_options' : ['--check-mac-addresses'],
               'function' : check_mac_addresses, 'trigger':'platform ready'}]

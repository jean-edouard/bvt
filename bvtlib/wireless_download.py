...
from bvtlib.settings import NO_WIFI_MACHINES
...
TEST_CASES = [{'description':'Download content over specific wireless network',
               'arguments': [('dut', '$(DUT)')], 'bvt':False,
               'command_line_options': ['--wireless-download'],
               'unsuitable_duts': NO_WIFI_MACHINES,
               'function' : wireless_download, 'trigger':'platform ready'}]

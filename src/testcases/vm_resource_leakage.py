...
from src.bvtlib.domains import name_split, domain_address, wait_for_vm_to_stop, list_vms
...
def entry_fn(dut, guest):
    resource_leakage_test(dut, guest)

def desc():
    return 'Start and stop a guest, and see whether it left any mess behind it.'

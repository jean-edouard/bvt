...
from src.bvtlib.domains import name_split, find_domain, CannotFindDomain
from src.bvtlib.wait_for_guest import wait_for_guest
from src.testcases.install_tools import tools_install_problems, install_tools
from src.bvtlib.install_tools_windows import kill_prompt_remover
from src.testcases.install_guest import install_guest, download_image
from src.testcases.install_guest import create_vm
from src.testcases.archive_vhd import have_fresh_vhd
from src.bvtlib.settings import VHD_WITH_TOOLS_PATTERN, VHD_SANS_TOOLS_PATTERN, \
    MAXIMUM_VHD_AGE_DAYS
from src.bvtlib.retry import retry
from os.path import exists
from os import stat
from time import time
from src.bvtlib.get_build import try_get_build
...
def desc():
    return 'Ensure that $(OS_NAME) with tools is running' 

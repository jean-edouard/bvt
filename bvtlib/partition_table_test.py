...
from bvtlib.settings import MISALIGNED_PARTITION_MACHINES, MISALIGNED_PARTITIONS_DONTCARE_REGEXP
...
TEST_CASES = [
    { 'description': 'Check partitions are 4KB aligned', 
      'trigger':'platform ready', 'futile':futile,
      'function': partition_table_test, 'bvt':True,
      'command_line_options' : ['--partition-table-test'],
      'unsuitable_duts' : MISALIGNED_PARTITION_MACHINES,
      'arguments' : [('dut', '$(DUT)')]}]

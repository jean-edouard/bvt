...
from src.bvtlib import test_names
from src.bvtlib.settings import PXE_DIR, BUILD_SERVER, RELEASES_DIRECTORY
from src.bvtlib.settings import BUILD_REGEXP, BUILDBOT2_BUILDER_URL
from src.bvtlib.settings import XENCLIENT_JSON_BUILDER, XENCLIENT_BUILDER_FORMAT
from src.bvtlib.settings import RELEASE_REGEXP
from src.bvtlib.settings import MONITORED_LOCATION, MONITORED_REPOSITORY
from src.bvtlib.settings import BUILDBOT2_BUILDER_FORMAT, BUILDBOT2_ALL_BUILDERS_URL

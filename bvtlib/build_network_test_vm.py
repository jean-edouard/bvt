...
from bvtlib.linux_guest import create_file
...
TEST_CASES = [
    { 'description': 'Build network test VM from scratch', 
      'trigger': 'VM ready',
      'function' : build_network_test_vm,
      'command_line_options': ['--build-network-test-vm'],
      'arguments' : [('dut', '$(DUT)')]}]

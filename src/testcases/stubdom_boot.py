...
from src.bvtlib.domains import name_split, domain_address, find_domain
from src.bvtlib.domains import wait_for_vm_to_stop
from src.bvtlib.windows_transitions import wait_for_windows_to_come_up
...
def entry_fn(dut, guest):
    stubdom_boot(dut, guest)

def desc():
    return 'Boot stubdom running OS'

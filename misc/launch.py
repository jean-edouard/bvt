...
from src.testcases.pxe_install_xc import XT_INSTALL_TEST_CASE
from src.bvtlib.validate_dut_name import validate_dut_name
from src.testcases import test_names
from src.bvtlib import mongodb
from src.bvtlib.get_build import get_build
from src.bvtlib.make_log_entry import make_log_entry
...
from src.testcases.store_status_report import store_status_report
from src.bvtlib.settings import DEFAULT_TAG_REGEXP
...
def launch():
    ...
    print 'INFO: run_bvt value: ', dutdoc.get('run_bvt',0)
